...
docker tag esacteksab/dev-container:"${DATE}" esacteksab/dev-container:latest

docker push esacteksab/dev-container:"${DATE}"
docker push esacteksab/dev-container:"${TAG}"
docker push esacteksab/dev-container:latest
